...
with psycopg2.connect(
    ...
    with open('north_data\employees_data.csv', 'r', encoding='utf-8') as file:
        ...
        for line in reader:
            with conn.cursor() as curs:
                curs.execute("INSERT INTO employees(employee_id,first_name,last_name,title,birth_date,notes) VALUES ("
                             "%s,%s,%s,%s,%s,%s)",
    ...
    with open('north_data\customers_data.csv', 'r', encoding='utf-8') as file:
        ...
        for line in reader:
            with conn.cursor() as curs:
                curs.execute("INSERT INTO customers(customer_id,company_name,contact_name) VALUES ("
                             "%s,%s,%s)",
    ...
    with open('north_data\orders_data.csv', 'r', encoding='utf-8') as file:
        ...
        for line in reader:
            with conn.cursor() as curs:
                curs.execute("INSERT INTO orders(order_id,customer_id,employee_id,order_date,ship_city) VALUES (%s,%s,%s,%s,%s)",
